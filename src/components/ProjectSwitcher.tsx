    ...
    return (
        <div className="relative" ref={dropdownRef}>
            ...
            <button
                ...
                className="w-full flex items-center gap-3 px-3 py-2.5 rounded-xl bg-[var(--card)] border border-[var(--border)] hover:border-[var(--primary)]/30 transition-all"
            >
                        ...
                        {isLoading ? (
                            ...
                            <>
                                ...
                                <button
                                    ...
                                    className={`w-full flex items-center gap-3 px-3 py-2.5 hover:bg-[var(--background)] transition-colors text-left ${!currentProject ? "bg-[var(--primary)]/10" : ""
                                        }`}
                                >
                                    <div className="w-7 h-7 rounded-lg bg-[var(--background)] border border-[var(--border)] flex items-center justify-center">
                                ...
                                {projects.map((project) => (
                                    <button
                                        ...
                                        className={`w-full flex items-center gap-3 px-3 py-2.5 hover:bg-[var(--background)] transition-colors text-left ${currentProject?.id === project.id ? "bg-[var(--primary)]/10" : ""
                                            }`}
                                    >
