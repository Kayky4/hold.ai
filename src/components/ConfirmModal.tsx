...
export default function ConfirmModal({
    ...
    return (
        <div className="fixed inset-0 z-50 flex items-center justify-center">
            ...
            <div
                ref={modalRef}
                className="relative bg-[var(--card)] border border-[var(--border)] rounded-2xl p-6 w-full max-w-md mx-4 shadow-2xl animate-fade-in"
            ...
            >
                ...
                <div className={`w-12 h-12 rounded-xl flex items-center justify-center mb-4 ${isDestructive
                    ...
                    {isDestructive ? (
                        <svg className="w-6 h-6 text-[var(--destructive)]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
