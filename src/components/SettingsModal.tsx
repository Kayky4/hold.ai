...
export default function SettingsModal({ isOpen, onClose }: SettingsModalProps) {
    ...
    return (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
            ...
            {/* Modal */}
            <div className="relative bg-[var(--card)] border border-[var(--border)] rounded-2xl shadow-2xl w-full max-w-lg overflow-hidden">
                {/* Header */}
                ...
                <div className="p-6">
                    <div className="text-center py-8">
                        ...
                        <div className="space-y-3 text-left max-w-xs mx-auto">
                            <div className="flex items-center gap-3 p-3 bg-[var(--background)] rounded-lg opacity-60">
                                ...
                                <div>
                                    ...
                                    <p className="text-xs text-[var(--muted)]">Claro / Escuro / Sistema</p>
                                </div>
                            </div>
                            ...
                            <div className="flex items-center gap-3 p-3 bg-[var(--background)] rounded-lg opacity-60">
                                ...
                                <div>
                                    <p className="text-sm font-medium text-[var(--foreground)]">Idioma</p>
                                    <p className="text-xs text-[var(--muted)]">Português / Inglês</p>
                                </div>
                            </div>
                            ...
                            <div className="flex items-center gap-3 p-3 bg-[var(--background)] rounded-lg opacity-60">
                                ...
                                <div>
                                    <p className="text-sm font-medium text-[var(--foreground)]">Notificações</p>
                                    <p className="text-xs text-[var(--muted)]">Alertas e lembretes</p>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div className="px-6 py-4 border-t border-[var(--border)] bg-[var(--background)]">
                    <button
                        onClick={onClose}
                        className="w-full px-4 py-2.5 bg-[var(--primary)] hover:bg-[var(--primary-hover)] text-white text-sm font-medium rounded-xl transition-colors"
                    >
                        Fechar
                    </button>
                </div>
